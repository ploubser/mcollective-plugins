module MCollective
  module Util
    ...
    #
    # allow    uid=500 status enable disable   country=uk or country=de     apache of mysql
    #
    ...
    # statements into one:
    #
    # allow    uid=500 status enable disable   (country=uk or country=de) and (apache of mysql)
    #
